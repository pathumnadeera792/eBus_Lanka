...
export default function ChooseSignUpPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Hero Section for Choose Sign Up */}
      <div 
      ...
      <div className="flex-grow flex flex-col md:flex-row items-center justify-center gap-10 py-16 px-4">
        ...
        {/* Card 1: Passenger Sign Up */}
        <Link 
          to="/register" // හෝ passenger signup route එක
        ...
        >
          ...
          <p className="text-gray-900 font-bold text-lg">
            Register to book tickets and manage trips
          </p>
        </Link>

        {/* Card 2: Bus Operator Sign Up */}
        <Link 
          to="/operator/register" // හෝ operator signup route එක
          className="bg-green-100 w-full max-w-sm p-12 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_15px_40px_rgba(34,197,94,0.3)] hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center border border-green-400 group"
        >
          ...
          <p className="text-gray-900 font-bold text-lg">
            Register your fleet and manage bookings
          </p>
        </Link>
